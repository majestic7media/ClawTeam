...
**新增依赖**: `redis` (pypi)，可选安装 `pip install openharness[redis]`
...
```bash
# 所有机器挂载同一个 NFS
export OH_DATA_DIR=/mnt/shared/openharness
# 零代码改动，直接可用
```
...
- 跨机器方案：SSHFS/云盘 + `OH_DATA_DIR`，零代码改动
